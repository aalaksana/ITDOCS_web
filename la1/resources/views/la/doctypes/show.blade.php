...
<div id="page-content" class="profile2">
 ...
 -->		<div class="col-md-4">
		...
		<li class="active"><a role="tab" data-toggle="tab" class="active" href="#tab-general-info" data-target="#tab-info" class="fa fa-bars"class="name">{{ $doctype->$view_col }}</a></li>
...
<!-- <ul datatoggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/doctypes') }}" data-toggle="tooltip" data-placement="right" title="Back to Doctypes"><i class="fa fa-chevron-left"></i></a></li>
