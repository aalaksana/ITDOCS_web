			...
			case 'Dropdown':
				...
				if(starts_with($field->popup_vals, "@")) {
					...
					if($update) {
						...
						if(Module::hasForeignKey($table->getTable(), $field->module_obj->name_db."_".$field->colname."foreign")){
							$table->dropForeign($field->module_obj->name_db."".$field->colname."_foreign");
							}
